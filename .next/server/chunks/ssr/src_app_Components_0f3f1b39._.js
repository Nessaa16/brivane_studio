...
const Faq1 = ()=>{
    const faqContent = [
        {
            title: 'What services does Brivane Studio offer?',
            content: 'We specialize in UI/UX design, branding design, website design, and graphic design. Our focus is to create strategic and visually compelling solutions that help brands grow and communicate effectively.'
        },
        {
            title: 'Who will be working on my project?',
            content: 'Brivane Studio is led by two designers, Bridget and Vanessa. Every project is handled directly by us to ensure consistency, quality, and strategic alignment.'
        },
        {
            title: 'Do you provide development services?',
            content: 'We focus primarily on design. However, we can collaborate with developers or provide handoff-ready design files for implementation.'
        },
        {
            title: 'How long does a project take?',
            content: 'Project timelines vary depending on scope and complexity.'
        },
        {
            title: 'Do you offer revisions?',
            content: 'Yes. We include revision rounds in our project scope to ensure the final result meets your expectations. The number of revisions will be clearly stated in the proposal.'
        }
    ];
