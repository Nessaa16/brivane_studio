...
const Team1 = () => {
    ...
    const teamContent = [
        {img:'/assets/img/team_1.jpg', name:'Bridget Beatrix Claire', content:'Founder',instagram:'#',facebook:'#',twitter:'#',linkedin:'https://www.linkedin.com/in/bridget-claire/'},
        {img:'/assets/img/team_2.jpg', name:'Vanessa Priscilia Wijaya', content:'Founder',instagram:'#',facebook:'#',twitter:'#',linkedin:'https://www.linkedin.com/in/vanessa-priscilia-wijaya-071b582b6/'},
      ];
    ...
    return (
        ...
        <div className="container items-center">
          ...
          <div className="row cs_row_gap_30 cs_gap_y_30 z-1">
