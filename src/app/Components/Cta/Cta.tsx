        ...
        <div className="container">
          ...
          <div className="cs_project_content position-relative">
            <div className="cs_project_heading text-center">
              ...
              <Link href="/contact" aria-label="Click to contact us" className="cs_btn cs_style_1 cs_fs_14 cs_bold text-uppercase wow fadeInUp mb-10"><span>CONTACT US</span></Link>
            </div>
            <div className="cs_height_120 cs_height_lg_80"></div>
          </div>
          <div className="cs_counter_grid_2">
            ...
            <div className="cs_counter_wrapper cs_type_1">
              ...
              <div className="cs_counter_number cs_fs_48 cs_bold cs_heading_color">
                <span data-count-to="4" className="odometer"></span>10+
              </div>
            </div>
          </div>
        </div>
